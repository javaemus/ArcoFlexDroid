...
public class tc8521
{
	...
	*/
	...
	public static int TC8521_TIMER_1_SECOND_COUNTER = 0x00;
	public static int TC8521_TIMER_10_SECOND_COUNTER = 0x01;
	public static int TC8521_TIMER_1_MINUTE_COUNTER = 0x02;
	public static int TC8521_TIMER_10_MINUTE_COUNTER = 0x03;
	public static int TC8521_TIMER_1_HOUR_COUNTER = 0x04;
	public static int TC8521_TIMER_10_HOUR_COUNTER = 0x05;
	public static int TC8521_TIMER_DAY_OF_THE_WEEK_COUNTER = 0x06;
	public static int TC8521_TIMER_1_DAY_COUNTER = 0x07;
	public static int TC8521_TIMER_10_DAY_COUNTER = 0x08;
	public static int TC8521_TIMER_1_MONTH_COUNTER = 0x09;
	public static int TC8521_TIMER_10_MONTH_COUNTER = 0x0a;
	public static int TC8521_TIMER_1_YEAR_COUNTER = 0x0b;
	public static int TC8521_TIMER_10_YEAR_COUNTER = 0x0c;
	
	public static int TC8521_MODE_REGISTER = 0x0d;
	public static int TC8521_TEST_REGISTER = 0x0e;
	public static int TC8521_RESET_REGISTER = 0x0f;
	
	public static int TC8521_ALARM_1_MINUTE_REGISTER = 0x012;
	public static int TC8521_ALARM_10_MINUTE_REGISTER = 0x013;
	public static int TC8521_ALARM_1_HOUR_REGISTER = 0x014;
	public static int TC8521_ALARM_10_HOUR_REGISTER = 0x015;
	public static int TC8521_ALARM_DAY_OF_THE_WEEK_REGISTER = 0x016;
	public static int TC8521_ALARM_1_DAY_REGISTER = 0x017;
	public static int TC8521_ALARM_10_DAY_REGISTER = 0x018;
	
	/* uncomment for verbose debugging information */
	//#define VERBOSE
	
	/* mask data with these values when writing */
	static int rtc_write_masks[]=
	{
	...
	public static int ALARM_OUTPUT_16HZ	= 0x01;
	public static int ALARM_OUTPUT_1HZ	= 0x02;
	public static int ALARM_OUTPUT_ALARM	= 0X04;
	
	public static class _tc8521
	{
		/* mame timer */
		public timer_entry tc8521_timer;
		/* 4 register pages (timer, alarm, ram1 and ram2) */
                public int[] registers = new int[16*4];
		/* interface for 1hz/16hz and alarm outputs */
                public tc8521_interface _interface;
	
		public int alarm_outputs;
		public int thirty_two_hz_counter;
	};
	
	static _tc8521 rtc = new _tc8521();
	
	
	/* read tc8521 data from supplied file */
	public static void tc8521_load_stream(Object file)
	{
		if (file != null)
		{
		/*TODO*///	osd_fread(file, rtc.registers[0], 16*4);
		/*TODO*///	osd_fread(file, rtc.alarm_outputs, sizeof(unsigned long));
		/*TODO*///	osd_fread(file, rtc.thirty_two_hz_counter, sizeof(unsigned long));
		}
	}
	
	/* write tc8521 data to supplied file */
	public static void tc8521_save_stream(Object file)
	{
		if (file != null)
		{
		/*TODO*///	osd_fwrite(file, &rtc.registers[0], sizeof(unsigned char)*16*4);
		/*TODO*///	osd_fwrite(file, &rtc.alarm_outputs, sizeof(unsigned long));
		/*TODO*///	osd_fwrite(file, &rtc.thirty_two_hz_counter, sizeof(unsigned long));
		}
	}
	
	static void tc8521_set_alarm_output()
	{
		int alarm_output;
	    ...
	    if (rtc._interface.alarm_output_callback!=null)
	    {
			rtc._interface.alarm_output_callback.handler(alarm_output);
		}
	}
	
	static void tc8521_alarm_check()
	{
	...
	static timer_callback tc8521_timer_callback = new timer_callback() {
	...
	public static void tc8521_init(tc8521_interface intf)
	{
	        //memset(&rtc, 0, sizeof(struct tc8521));
                rtc = new _tc8521();
	
	        //memset(&rtc.interface, 0, sizeof(struct tc8521_interface));
                rtc._interface = new tc8521_interface();
	        if (intf != null)
	        {
	...
	public static void tc8521_stop()
	{
	...
	public static ReadHandlerPtr tc8521_r = new ReadHandlerPtr() {
			...
			switch (offset)
			{
				...
				case 0x0f:
	/*TODO*///#ifdef VERBOSE
	/*TODO*///				logerror("8521 RTC R: %04x %02x\n", offset, rtc.registers[offset]);
	/*TODO*///#endif
	...
	public static WriteHandlerPtr tc8521_w = new WriteHandlerPtr() {
            public void handler(int offset, int data) {
                int register_index;
	
	/*TODO*///#ifdef VERBOSE
	/*TODO*///        logerror("8521 RTC W: %04x %02x\n", offset, data);
	/*TODO*///
	/*TODO*///		switch (offset)
	/*TODO*///        {
	/*TODO*///                case 0x0D:
	...
	/*TODO*///                        if (data & 0x08)
	/*TODO*///                        {
	/*TODO*///                            logerror("timer enable\n");
	/*TODO*///                        }
	/*TODO*///
	/*TODO*///                        if (data & 0x04)
	/*TODO*///                        {
	/*TODO*///                            logerror("alarm enable\n");
	/*TODO*///                        }
	/*TODO*///
	/*TODO*///						logerror("page %02x selected\n", data & 0x03);
	/*TODO*///	              }
	/*TODO*///                break;
	/*TODO*///
	/*TODO*///                case 0x0e:
	...
	/*TODO*///                        if (data & 0x08)
	/*TODO*///                        {
	/*TODO*///                            logerror("test 3\n");
	/*TODO*///                        }
	/*TODO*///
	/*TODO*///                        if (data & 0x04)
	/*TODO*///                        {
	/*TODO*///                            logerror("test 2\n");
	/*TODO*///                        }
	/*TODO*///
	/*TODO*///                        if (data & 0x02)
	/*TODO*///                        {
	/*TODO*///                            logerror("test 1\n");
	/*TODO*///                        }
	/*TODO*///
	/*TODO*///                        if (data & 0x01)
	/*TODO*///                        {
	/*TODO*///                            logerror("test 0\n");
	/*TODO*///                        }
	/*TODO*///                }
	/*TODO*///                break;
	/*TODO*///
	...
	/*TODO*///                        if ((data & 0x08)==0)
	/*TODO*///                        {
	/*TODO*///                           logerror("1hz enable\n");
	/*TODO*///                        }
	/*TODO*///
	/*TODO*///                        if ((data & 0x04)==0)
	/*TODO*///                        {
	/*TODO*///                           logerror("16hz enable\n");
	/*TODO*///                        }
	/*TODO*///
	/*TODO*///                        if (data & 0x02)
	/*TODO*///                        {
	/*TODO*///                           logerror("reset timer\n");
	/*TODO*///                        }
	/*TODO*///
	/*TODO*///                        if (data & 0x01)
	/*TODO*///                        {
	/*TODO*///                           logerror("reset alarm\n");
	/*TODO*///                        }
	/*TODO*///                }
	/*TODO*///                break;
	/*TODO*///
