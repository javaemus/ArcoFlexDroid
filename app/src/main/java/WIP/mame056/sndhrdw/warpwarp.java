...
public class warpwarp
{
	...
	public static int CLOCK_16H	= (18432000/3/2/16);
	public static int CLOCK_1V      = (18432000/3/2/384);
	...
	static timer_entry sound_volume_timer = null;
	static int music_signal = 0;
	static int music_volume = 0;
	static timer_entry music_volume_timer = null;
	static int noise = 0;
	
	static timer_callback sound_volume_decay = new timer_callback() {
	...
	static timer_callback music_volume_decay = new timer_callback() {
            public void handler(int param) {
                if( --music_volume < 0 )
	        music_volume = 0;
            }
	...
	static StreamInitPtr warpwarp_sound_update = new StreamInitPtr() {
