...
import static WIP.mame056.sndhrdw._8080bw.*;
...
public class _8080bw
{
	...
	static String invad2ct_sample_names[] =
	{
		"*invaders",
	...
	*/
	...
	static void invaders_sh_1_w(int board, int data, int last)
	{
		...
		SN76477_enable_w(board, (data & 0x01)!=0?0:1);				/* Saucer Sound */
	
		if (((data & 0x02) != 0) && ((~last & 0x02) != 0))
	...
	static void invaders_sh_2_w(int board, int data, int last)
	{
		int base_channel, base_sample;
	...
	static void sheriff_74123_0_output_changed_cb()
	{
		/*TODO*///SN76477_vco_w    (0,  TTL74123_output_r(0));
		/*TODO*///SN76477_mixer_b_w(0, !TTL74123_output_r(0));
	
		/*TODO*///SN76477_enable_w(0, TTL74123_output_comp_r(0) && TTL74123_output_comp_r(1));
	}
	
	static void sheriff_74123_1_output_changed_cb()
	{
	...
	/*TODO*///static struct TTL74123_interface sheriff_74123_0_intf =
	/*TODO*///{
	/*TODO*///	RES_K(33),
	/*TODO*///	CAP_U(33),
	...
	/*TODO*///static struct TTL74123_interface sheriff_74123_1_intf =
	/*TODO*///{
	/*TODO*///	RES_K(33),
	/*TODO*///	CAP_U(33),
	...
	public static WriteHandlerPtr sheriff_sh_p2_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		DAC_data_w(0, ((sheriff_p2 & 0x80) != 0) ? 0xff : 0x00);
	} };
	...
	public static WriteHandlerPtr schaser_sh_port3_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		SN76477_enable_w(0, explosion!=0?0:1);
	...
	public static WriteHandlerPtr schaser_sh_port5_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		DAC_data_w(0, (data & 0x01)!=0 ? 0xff : 0x00);
	...
	public static ShStartPtr schaser_sh_start = new ShStartPtr() {
		...
		mixer_play_sample_16(channel_dot,new ShortPtr(backgroundwave),backgroundwave.length,1000,1);
