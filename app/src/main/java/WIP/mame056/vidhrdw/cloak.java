...
public class cloak
{
	...
	static mame_bitmap tmpbitmap2, charbitmap;
	static int x,y,bmap;
	public static UBytePtr tmpvideoram=new UBytePtr(), tmpvideoram2=new UBytePtr();
	...
	***************************************************************************/
	...
	public static VhUpdatePtr cloak_vh_screenrefresh = new VhUpdatePtr() { public void handler(mame_bitmap bitmap,int full_refresh) 
	{
		...
		copybitmap(bitmap, bmap!=0 ? tmpbitmap2 : tmpbitmap, 0,0,0,0,Machine.visible_area,TRANSPARENCY_COLOR,16);
