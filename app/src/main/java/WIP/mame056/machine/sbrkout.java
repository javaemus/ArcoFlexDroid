...
public class sbrkout
{
	...
	public static int SBRKOUT_PROGRESSIVE = 0x00;
	public static int SBRKOUT_DOUBLE      = 0x01;
	public static int SBRKOUT_CAVITY      = 0x02;
	
	public static int sbrkout_game_switch = SBRKOUT_PROGRESSIVE;
