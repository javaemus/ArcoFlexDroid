...
import static WIP.mame056.vidhrdw.psychic5.*;
...
public class psychic5
{
    ...
    PORT_START(); 
	    ...
	    PORT_DIPSETTING(    0x08, "Normal" );    PORT_DIPSETTING(    0x00, "Hard" );    PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Cabinet") );
	...
	(
		...
		53.8f, DEFAULT_60HZ_VBLANK_DURATION,	/* frames per second, vblank duration */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_psychic5 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "p5d",          0x00000, 0x08000, 0x90259249 );	ROM_LOAD( "p5e",          0x10000, 0x10000, 0x72298f34 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );				/*64K for 2nd z80 CPU*/
		ROM_LOAD( "p5a",          0x00000, 0x08000, 0x50060ecd );
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "p5b",          0x00000, 0x10000, 0x7e3f87d4 );/* sprite tiles */
		ROM_LOAD( "p5c",          0x10000, 0x10000, 0x8710fedb );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "p5g",          0x00000, 0x10000, 0xf9262f32 );/* background tiles */
		ROM_LOAD( "p5h",          0x10000, 0x10000, 0xc411171a );
		ROM_REGION( 0x08000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "p5f",          0x00000, 0x08000, 0x04d7e21c );/* foreground tiles */
	ROM_END(); }}; 
