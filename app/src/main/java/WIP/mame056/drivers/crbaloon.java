...
import static WIP.mame056.vidhrdw.crbaloon.*;
...
public class crbaloon
{
	...
	public static IO_ReadPort readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x0f, crbaloon_IN_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x02, 0x04, crbaloon_spritectrl_w ),
	...
	PORT_START(); 
		PORT_DIPNAME( 0x01, 0x01, "Test?" );	PORT_DIPSETTING(    0x01, "I/O Check?" );	PORT_DIPSETTING(    0x00, "RAM Check?" );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Cabinet") );
		...
		PORT_DIPSETTING(    0x00, "5000" );	PORT_DIPSETTING(    0x10, "10000" );	PORT_DIPNAME( 0xe0, 0x80, DEF_STR( "Coinage") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_BUTTON1, "High Score Name Reset", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN2 );/* should be COIN2 */
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_TILT );	/* the following four bits come from chip PC3092 */
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_crbaloon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "cl01.bin",     0x0000, 0x0800, 0x9d4eef0b );	ROM_LOAD( "cl02.bin",     0x0800, 0x0800, 0x10f7a6f7 );	ROM_LOAD( "cl03.bin",     0x1000, 0x0800, 0x44ed6030 );	ROM_LOAD( "cl04.bin",     0x1800, 0x0800, 0x62f66f6c );	ROM_LOAD( "cl05.bin",     0x2000, 0x0800, 0xc8f1e2be );	ROM_LOAD( "cl06.bin",     0x2800, 0x0800, 0x7d465691 );
		ROM_REGION( 0x0800, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cl07.bin",     0x0000, 0x0800, 0x2c1fbea8 );
		ROM_REGION( 0x0800, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "cl08.bin",     0x0000, 0x0800, 0xba898659 );ROM_END(); }}; 
	
	static RomLoadPtr rom_crbalon2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );    /* 64k for code */
		ROM_LOAD( "cl01.bin",     0x0000, 0x0800, 0x9d4eef0b );	ROM_LOAD( "crazybal.ep2", 0x0800, 0x0800, 0x87572086 );	ROM_LOAD( "crazybal.ep3", 0x1000, 0x0800, 0x575fe995 );	ROM_LOAD( "cl04.bin",     0x1800, 0x0800, 0x62f66f6c );	ROM_LOAD( "cl05.bin",     0x2000, 0x0800, 0xc8f1e2be );	ROM_LOAD( "crazybal.ep6", 0x2800, 0x0800, 0xfed6ff5c );
		ROM_REGION( 0x0800, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cl07.bin",     0x0000, 0x0800, 0x2c1fbea8 );
		ROM_REGION( 0x0800, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "cl08.bin",     0x0000, 0x0800, 0xba898659 );ROM_END(); }}; 
