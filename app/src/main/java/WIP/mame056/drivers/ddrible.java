...
import static WIP.mame056.vidhrdw.ddrible.*;
import static WIP.mame056.machine.ddrible.*;
...
public class ddrible
{
	...
	{
		UBytePtr SPEECH_ROM = new UBytePtr(memory_region(REGION_SOUND1));
		/* b7 : vlm data bus OE   */
		/* b6 : VLM5030-RST       */
		/* b5 : VLM5030-ST        */
		/* b4 : VLM5300-VCU       */
