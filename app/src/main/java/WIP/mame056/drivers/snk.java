...
/**
    ...
    static Memory_ReadAddress YM3526_readmem_sound[] = {
        new Memory_ReadAddress(0x0000, 0x7fff, MRA_ROM),
        new Memory_ReadAddress(0x8000, 0x87ff, MRA_RAM),
        new Memory_ReadAddress(0xa000, 0xa000, soundlatch_r),
        new Memory_ReadAddress(0xc000, 0xc000, snk_soundlatch_clear),
        new Memory_ReadAddress(0xe000, 0xe000, YM3526_status_port_0_r),
        new Memory_ReadAddress(MEMPORT_MARKER, 0)
    };

    static Memory_WriteAddress YM3526_writemem_sound[] = {
    ...
    static Memory_ReadAddress YM3526_YM3526_readmem_sound[] = {
    ...
    static Memory_WriteAddress YM3526_YM3526_writemem_sound[] = {
    ...
    static Memory_ReadAddress YM3526_Y8950_readmem_sound[] = {
        new Memory_ReadAddress(0x0000, 0xbfff, MRA_ROM),
        new Memory_ReadAddress(0xc000, 0xcfff, MRA_RAM),
        new Memory_ReadAddress(0xe000, 0xe000, soundlatch_r),
    ...
    static Memory_WriteAddress YM3526_Y8950_writemem_sound[] = {
        new Memory_WriteAddress(0x0000, 0xbfff, MWA_ROM),
        new Memory_WriteAddress(0xc000, 0xcfff, MWA_RAM),
    ...
    static Memory_ReadAddress YM3812_Y8950_readmem_sound[] = {
        new Memory_ReadAddress(0x0000, 0xbfff, MRA_ROM),
        new Memory_ReadAddress(0xc000, 0xcfff, MRA_RAM),
        new Memory_ReadAddress(0xe000, 0xe000, soundlatch_r),
    ...
    static Memory_WriteAddress YM3812_Y8950_writemem_sound[] = {
        new Memory_WriteAddress(0x0000, 0xbfff, MWA_ROM),
        new Memory_WriteAddress(0xc000, 0xcfff, MWA_RAM),
    ...
    static Memory_ReadAddress Y8950_readmem_sound[] = {
        new Memory_ReadAddress(0x0000, 0xbfff, MRA_ROM),
        new Memory_ReadAddress(0xc000, 0xcfff, MRA_RAM),
        new Memory_ReadAddress(0xe000, 0xe000, soundlatch_r),
    ...
    static Memory_WriteAddress Y8950_writemem_sound[] = {
        new Memory_WriteAddress(0x0000, 0xbfff, MWA_ROM),
        new Memory_WriteAddress(0xc000, 0xcfff, MWA_RAM),
    ...
    static Memory_ReadAddress tnk3_readmem_cpuA[]
            = {
                new Memory_ReadAddress(0x0000, 0xbfff, MRA_ROM),
    ...
    static Memory_WriteAddress tnk3_writemem_cpuA[]
            = {
                new Memory_WriteAddress(0x0000, 0xbfff, MWA_ROM),
    ...
    static Memory_ReadAddress tnk3_readmem_cpuB[]
            = {
                new Memory_ReadAddress(0x0000, 0xbfff, MRA_ROM),
    ...
    static Memory_WriteAddress tnk3_writemem_cpuB[]
            = {
                new Memory_WriteAddress(0x0000, 0xbfff, MWA_ROM),
    ...
    static Memory_ReadAddress readmem_cpuA[]
            = {
                new Memory_ReadAddress(0x0000, 0xbfff, MRA_ROM),
                new Memory_ReadAddress(0xc000, 0xcfff, cpuA_io_r),
    ...
    static Memory_WriteAddress writemem_cpuA[]
            = {
                new Memory_WriteAddress(0x0000, 0xbfff, MWA_ROM),
                new Memory_WriteAddress(0xc000, 0xcfff, cpuA_io_w, io_ram),
    ...
    static Memory_ReadAddress readmem_cpuB[]
            = {
                new Memory_ReadAddress(0x0000, 0xbfff, MRA_ROM),
    ...
    static Memory_WriteAddress writemem_cpuB[]
            = {
                new Memory_WriteAddress(0x0000, 0xbfff, MWA_ROM),
    ...
    static RomLoadPtr rom_fitegolf = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x8000, REGION_GFX2,0);/* tiles */

            ROM_LOAD("gu7", 0x0000, 0x8000, 0x4655f94e);

            ROM_REGION(0x18000, REGION_GFX3, 0);/* sprites */
    ...
    static RomLoadPtr rom_ikari = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x20000, REGION_GFX2, 0);/* tiles */
            ...
            ROM_REGION(0x30000, REGION_GFX4, 0);/* 32x32 sprites */
    ...
    static RomLoadPtr rom_victroad = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x40000, REGION_GFX4, 0);/* 32x32 sprites */
    ...
    static RomLoadPtr rom_gwarb = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x8000, REGION_GFX1, 0);/* characters */

            ROM_LOAD("g05", 0x0000, 0x08000, 0x80f73e2e);

            ROM_REGION(0x40000, REGION_GFX2, 0);/* background tiles */
            ...
            ROM_REGION(0x40000, REGION_GFX3, 0);/* 16x16 sprites */
            ...
            ROM_REGION(0x80000, REGION_GFX4, 0);/* 32x32 sprites */
    ...
    static RomLoadPtr rom_bermudat = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x40000, REGION_GFX2, 0);/* tiles */
    ...
    static RomLoadPtr rom_ftsoccer = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x50000, REGION_GFX2, 0);/* background tiles */

            ROM_LOAD("ft-014.bin", 0x00000, 0x10000, 0x38c38b40);
            ROM_LOAD("ft-015.bin", 0x10000, 0x10000, 0xa614834f);

	//	ROM_REGION( 0x40000, REGION_GFX3, 0 );/* 16x16 sprites */
            ROM_REGION(0x80000, REGION_GFX3, 0);/* 32x32 sprites */
    ...
    static RomLoadPtr rom_tdfever = new RomLoadPtr() {
        public void handler() {  /* USA set */
            ...
            ROM_REGION(0x50000, REGION_GFX2, 0);/* tiles */
    ...
    public static GameDriver driver_bermudaa = new GameDriver("1987", "bermudaa", "snk.java", rom_bermudaa, driver_bermudat, machine_driver_bermudat, input_ports_bermudat, init_worldwar, ROT270, "SNK", "Bermuda Triangle (US early version)", GAME_NO_COCKTAIL);
    public static GameDriver driver_worldwar = new GameDriver("1987", "worldwar", "snk.java", rom_worldwar, driver_bermudat, machine_driver_bermudat, input_ports_bermudat, init_worldwar, ROT270, "SNK", "World Wars (Japan)", GAME_NO_COCKTAIL);
