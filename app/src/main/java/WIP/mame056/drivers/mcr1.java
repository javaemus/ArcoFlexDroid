...
public class mcr1
{
	...
	/* constants */
	public static int MAIN_OSC = 19968000;
	
	static UBytePtr nvram_init=new UBytePtr();
	...
	public static nvramPtr mcr1_nvram_handler = new nvramPtr() {
		...
		if (read_or_write != 0)
			osd_fwrite(file, new UBytePtr(ram,0x7000), 0x800);
		else if (file != null)
			osd_fread(file, new UBytePtr(ram,0x7000), 0x800);
		else if (nvram_init != null)
			memcpy(new UBytePtr(ram,0x7000), nvram_init, 16);
            }
        };
	...
	public static InitDriverPtr init_solarfox = new InitDriverPtr() { public void handler()
	{
		int[] hiscore_init = { 0,0,1,1,1,1,1,3,3,3,7 };
		nvram_init = new UBytePtr(hiscore_init.length);
	...
	public static InitDriverPtr init_kick = new InitDriverPtr() { public void handler()
	{
		nvram_init = null;
