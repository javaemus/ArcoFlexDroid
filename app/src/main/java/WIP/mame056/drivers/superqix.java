...
import static WIP.mame056.vidhrdw.superqix.*;
...
public class superqix
{
	...
	public static IO_ReadPort readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x0000, 0x00ff, paletteram_r ),
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x0000, 0x00ff, paletteram_BBGGRRII_w ),
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_4WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_4WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_4WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_VBLANK );/* ??? */
		PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(    0x80, 0x00, IPT_DIPSWITCH_NAME, "Freeze???", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		...
		PORT_DIPSETTING(    0x08, "20000 50000" );	PORT_DIPSETTING(    0x0c, "30000 100000" );	PORT_DIPSETTING(    0x04, "50000 100000" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x20, "2" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x10, "4" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0xc0, 0xc0, "Fill Area" );	PORT_DIPSETTING(    0x80, "70%" );	PORT_DIPSETTING(    0xc0, "75%" );	PORT_DIPSETTING(    0x40, "80%" );	PORT_DIPSETTING(    0x00, "85%" );
		PORT_START(); 	/* IN2 */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_superqix = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "sq01.97",      0x00000, 0x08000, 0x0888b7de );	ROM_LOAD( "sq02.96",      0x10000, 0x10000, 0x9c23cb64 );
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "sq04.2",       0x00000, 0x08000, 0xf815ef45 );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "sq03.3",       0x00000, 0x10000, 0x6e8b6a67 );	ROM_LOAD( "sq06.14",      0x10000, 0x10000, 0x38154517 );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "sq05.1",       0x00000, 0x10000, 0xdf326540 );
		ROM_REGION( 0x1000, REGION_USER1, 0 );/* Unknown (protection related?) */
		ROM_LOAD( "sq07.108",     0x00000, 0x1000, 0x071a598c );ROM_END(); }}; 
	
	static RomLoadPtr rom_sqixbl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1, 0 );/* 64k for code */
		ROM_LOAD( "cpu.2",        0x00000, 0x08000, 0x682e28e3 );	ROM_LOAD( "sq02.96",      0x10000, 0x10000, 0x9c23cb64 );
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "sq04.2",       0x00000, 0x08000, 0xf815ef45 );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "sq03.3",       0x00000, 0x10000, 0x6e8b6a67 );	ROM_LOAD( "sq06.14",      0x10000, 0x10000, 0x38154517 );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "sq05.1",       0x00000, 0x10000, 0xdf326540 );ROM_END(); }}; 
