...
import static WIP.mame056.vidhrdw.flstory.*;
import static WIP.mame056.machine.flstory.*;
...
public class flstory
{
	...
	public static Memory_ReadAddress m68705_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x0000, flstory_68705_portA_r ),
	...
	public static Memory_WriteAddress m68705_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0000, flstory_68705_portA_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_flstory = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT );	ROM_LOAD( "vid-a45.18",   0x00000, 0x4000, 0x6f08f69e );	ROM_LOAD( "vid-a45.06",   0x04000, 0x4000, 0xdc856a75 );	ROM_LOAD( "vid-a45.08",   0x08000, 0x4000, 0xd0b028ca );	ROM_LOAD( "vid-a45.20",   0x0c000, 0x4000, 0x1b0edf34 );	ROM_LOAD( "vid-a45.19",   0x10000, 0x4000, 0x2b572dc9 );	ROM_LOAD( "vid-a45.07",   0x14000, 0x4000, 0xaa4b0762 );	ROM_LOAD( "vid-a45.09",   0x18000, 0x4000, 0x8336be58 );	ROM_LOAD( "vid-a45.21",   0x1c000, 0x4000, 0xfc382bd1 );ROM_END(); }}; 
