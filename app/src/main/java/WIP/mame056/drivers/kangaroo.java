...
import static WIP.mame056.vidhrdw.kangaroo.*;


public class kangaroo
{
	public static InitMachinePtr kangaroo_init_machine = new InitMachinePtr() { public void handler()
	{
	...
	*/
	...
	public static IO_WritePort sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x7000, 0x7000, AY8910_write_port_0_w ),
