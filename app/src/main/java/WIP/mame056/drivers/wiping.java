...
import static WIP.mame056.vidhrdw.wiping.*;
...
public class wiping
{
	...
	PORT_START(); 	/* 0 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_4WAY );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_4WAY );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_4WAY );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_4WAY );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0xe0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* 1 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0xe0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* 2 */
		...
		PORT_START(); 	/* 6 */
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x05, IP_ACTIVE_LOW, IPT_COIN2 );/* note that this changes two bits */
		PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_START2 );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
		PORT_SERVICE( 0x40, IP_ACTIVE_HIGH );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "30000 70000" );	PORT_DIPSETTING(    0x80, "50000 150000" );
		PORT_START(); 	/* 7 */
	...
	//	PORT_DIPSETTING(    0x00, "Disable" );	PORT_DIPNAME( 0x38, 0x08, DEF_STR( "Coin_A") );
		...
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x40, "3" );	PORT_DIPSETTING(    0x80, "4" );	PORT_DIPSETTING(    0xc0, "5" );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* 0 */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
		PORT_SERVICE( 0x40, IP_ACTIVE_HIGH );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "100000 200000" );	PORT_DIPSETTING(    0x80, "150000 300000" );
		PORT_START(); 	/* 7 */
		PORT_DIPNAME( 0x07, 0x01, DEF_STR( "Coin_B") );
		PORT_DIPSETTING(    0x01, DEF_STR( "1C_1C") );
		PORT_DIPSETTING(    0x02, DEF_STR( "1C_2C") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_wiping = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "1",            0x0000, 0x2000, 0xb55d0d19 );	ROM_LOAD( "2",            0x2000, 0x2000, 0xb1f96e47 );	ROM_LOAD( "3",            0x4000, 0x2000, 0xc67bab5a );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound cpu */
		ROM_LOAD( "4",            0x0000, 0x1000, 0xa1547e18 );
		ROM_REGION( 0x1000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "8",            0x0000, 0x1000, 0x601160f6 );/* chars */
	
		ROM_REGION( 0x2000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "7",            0x0000, 0x2000, 0x2c2cc054 );/* sprites */
	
		ROM_REGION( 0x0220, REGION_PROMS, 0 );	ROM_LOAD( "wip-g13.bin",  0x0000, 0x0020, 0xb858b897 );/* palette */
		...
		ROM_LOAD( "rugr5c8",	  0x0000, 0x2000, 0x67bafbbf );	ROM_LOAD( "rugr6c9",	  0x2000, 0x2000, 0xcac84a87 );
	...
	static RomLoadPtr rom_rugrats = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* main cpu code */
		ROM_LOAD( "rugr1d1",      0x0000, 0x2000, 0xe7e1bd6d );	ROM_LOAD( "rugr2d2",      0x2000, 0x2000, 0x5f47b9ad );	ROM_LOAD( "rugr3d3",      0x4000, 0x2000, 0x3d748d1a );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound cpu */
		ROM_LOAD( "rugr4c4",      0x0000, 0x2000, 0xd4a92c38 );
		ROM_REGION( 0x1000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rugr8d2",      0x0000, 0x1000, 0xa3dcaca5 );/* chars */
	
		ROM_REGION( 0x2000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "rugr7c13",     0x0000, 0x2000, 0xfe1191dd );/* sprites */
	
		ROM_REGION( 0x0220, REGION_PROMS, 0 );	ROM_LOAD( "prom.13g",     0x0000, 0x0020, 0xf21238f0 );/* palette */
