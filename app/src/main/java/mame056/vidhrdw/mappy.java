...
public class mappy
{
	...
	public static UBytePtr mappy_scroll = new UBytePtr(5);
	...
	***************************************************************************/
	...
	{
		mappy_scroll.write(offset >> 3);
	} };
	
	
	
	public static void mappy_draw_sprite(mame_bitmap dest,int code,int color,
	...
	***************************************************************************/
	public static VhUpdatePtr mappy_vh_screenrefresh = new VhUpdatePtr() { public void handler(mame_bitmap bitmap,int full_refresh) 
	{
		...
		/* copy the temporary bitmap to the screen */
		{
			...
			copyscrollbitmap(bitmap,tmpbitmap,0,new int[]{0},36,scroll,Machine.visible_area,TRANSPARENCY_NONE,0);
		}
