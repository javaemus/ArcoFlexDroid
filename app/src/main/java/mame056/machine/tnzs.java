...
public class tnzs
{
	...
	//enum
	//{
	public static final int	MCU_NONE        = 1;
	public static final int	MCU_EXTRMATN    = 2;
	public static final int	MCU_ARKANOID    = 3;
	public static final int	MCU_DRTOPPEL    = 4;
	public static final int	MCU_CHUKATAI    = 5;
	public static final int	MCU_TNZS        = 6;
	//};
	...
	static int mcu_coinsA,mcu_coinsB,mcu_credits;
	...
	public static ReadHandlerPtr tnzs_mcu_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		{
			case MCU_ARKANOID:
				return mcu_arknoid2_r.handler(offset);
				//break;
			case MCU_CHUKATAI:
	...
	public static WriteHandlerPtr tnzs_mcu_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		{
			case MCU_ARKANOID:
				mcu_arknoid2_w.handler(offset,data);
				break;
			case MCU_CHUKATAI:
