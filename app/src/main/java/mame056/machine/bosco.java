...
public class bosco
{
	...
	static timer_entry nmi_timer_1, nmi_timer_2;
	...
	***************************************************************************/
		...
		switch (customio_command_1)
		{
			...
			case 0x84:
				if (offset == 2)
				{
					int hi = (data / 16);
					int mid = (data % 16);
					if (customio_1.read(1) == 0x20)
						FirstBonus = (hi * 100000) + (mid * 10000);
					if (customio_1.read(1) == 0x30)
	...
	public static WriteHandlerPtr bosco_customio_1_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		{
			case 0x10:
				if (nmi_timer_1 != null) timer_remove (nmi_timer_1);
				nmi_timer_1 = null;
				return;
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr bosco_customio_2_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		{
			case 0x10:
				if (nmi_timer_2 != null) timer_remove (nmi_timer_2);
				nmi_timer_2 = null;
				return;
		}
