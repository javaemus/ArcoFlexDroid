...
import static mame056.vidhrdw.arabian.*;
...
public class arabian
{
	...
	/* constants */
	public static int MAIN_OSC = 12000000;
	
	
	/* local variables */
	static int custom_cpu_reset;
	static int custom_cpu_busy;
	static UBytePtr custom_cpu_ram = new UBytePtr();
	...
	public static ReadHandlerPtr custom_cpu_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (custom_cpu_reset != 0)
			return custom_cpu_ram.read(0x7f0 + offset);
		...
		switch (offset)
		{
			...
			case 8:
				return custom_cpu_ram.read(0x7f0 + offset - 1);
	...
	static void update_flip_state()
	{
		...
		arabian_flip_screen = custom_cpu_ram.read(0x34b);
	
		/* flip if not player 1 and cocktail mode */
		if ((custom_cpu_ram.read(0x400) != 0) && ((custom_cpu_ram.read(0x401) & 0x02) == 0))
			arabian_flip_screen = arabian_flip_screen!=0?0:1;
	}
	
	
	public static WriteHandlerPtr custom_flip_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		custom_cpu_ram.write(0x34b + offset, data);
		update_flip_state();
	} };
	...
	{
		custom_cpu_ram.write(0x400 + offset, data);
		update_flip_state();
	} };
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0xc800, 0xc800, AY8910_control_port_0_w ),
	...
	PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_SERVICE( 0x04, IP_ACTIVE_HIGH );	PORT_BIT( 0xf8, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START();       /* DSW1 */
		...
		PORT_DIPNAME( 0x08, 0x00, "Carry Bowls to Next Life" );	PORT_DIPSETTING(    0x08, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0xf0, 0x00, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x10, "A 2/1 B 2/1" );	PORT_DIPSETTING(    0x20, "A 2/1 B 1/3" );	PORT_DIPSETTING(    0x00, "A 1/1 B 1/1" );	PORT_DIPSETTING(    0x30, "A 1/1 B 1/2" );	PORT_DIPSETTING(    0x40, "A 1/1 B 1/3" );	PORT_DIPSETTING(    0x50, "A 1/1 B 1/4" );	PORT_DIPSETTING(    0x60, "A 1/1 B 1/5" );	PORT_DIPSETTING(    0x70, "A 1/1 B 1/6" );	PORT_DIPSETTING(    0x80, "A 1/2 B 1/2" );	PORT_DIPSETTING(    0x90, "A 1/2 B 1/4" );	PORT_DIPSETTING(    0xa0, "A 1/2 B 1/6" );	PORT_DIPSETTING(    0xb0, "A 1/2 B 1/10" );	PORT_DIPSETTING(    0xc0, "A 1/2 B 1/11" );	PORT_DIPSETTING(    0xd0, "A 1/2 B 1/12" );	PORT_DIPSETTING(    0xf0, DEF_STR( "Free_Play") );
		/* 0xe0 gives A 1/2 B 1/6 */
	
		PORT_START();       /* COM0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_COIN3 );	/* IN3 */
	
		PORT_START();       /* COM1 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY );
		PORT_START();       /* COM2 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* IN9 */
		PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* IN10 */
		PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* IN11 */
	
		PORT_START();       /* COM3 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );
		PORT_START();       /* COM4 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* IN17 */
		PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* IN18 */
		PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* IN19 */
	
		PORT_START();       /* COM5 */
		PORT_DIPNAME( 0x01, 0x00, "Coin Chutes" );	PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x04, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x04, "20000" );	PORT_DIPSETTING(    0x08, "40000" );	PORT_DIPSETTING(    0x0c, "20000 50000 +100K" );	PORT_DIPSETTING(    0x00, "None" );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_arabian = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "ic1rev2.87", 0x0000, 0x2000, 0x5e1c98b8 );	ROM_LOAD( "ic2rev2.88", 0x2000, 0x2000, 0x092f587e );	ROM_LOAD( "ic3rev2.89", 0x4000, 0x2000, 0x15145f23 );	ROM_LOAD( "ic4rev2.90", 0x6000, 0x2000, 0x32b77b44 );
		ROM_REGION( 0x10000, REGION_GFX1, 0 );	ROM_LOAD( "ic84.91",    0x0000, 0x2000, 0xc4637822 );	ROM_LOAD( "ic85.92",    0x2000, 0x2000, 0xf7c6866d );	ROM_LOAD( "ic86.93",    0x4000, 0x2000, 0x71acd48d );	ROM_LOAD( "ic87.94",    0x6000, 0x2000, 0x82160b9a );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_arabiana = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "ic1.87",     0x0000, 0x2000, 0x51e9a6b1 );	ROM_LOAD( "ic2.88",     0x2000, 0x2000, 0x1cdcc1ab );	ROM_LOAD( "ic3.89",     0x4000, 0x2000, 0xb7b7faa0 );	ROM_LOAD( "ic4.90",     0x6000, 0x2000, 0xdbded961 );
		ROM_REGION( 0x10000, REGION_GFX1, 0 );	ROM_LOAD( "ic84.91",    0x0000, 0x2000, 0xc4637822 );	ROM_LOAD( "ic85.92",    0x2000, 0x2000, 0xf7c6866d );	ROM_LOAD( "ic86.93",    0x4000, 0x2000, 0x71acd48d );	ROM_LOAD( "ic87.94",    0x6000, 0x2000, 0x82160b9a );ROM_END(); }}; 
	...
	public static InitDriverPtr init_arabian = new InitDriverPtr() { public void handler()
	{
