...
public class hal21
{
	...
	public static void aso_draw_sprites(
			mame_bitmap bitmap,
	...
	*/
	...
	public static int SNK_NMI_ENABLE = 1;
	public static int SNK_NMI_PENDING = 2;
	
	static int snk_soundcommand = 0;
	static UBytePtr shared_ram=new UBytePtr(), shared_auxram=new UBytePtr();
	
	public static ReadHandlerPtr shared_auxram_r  = new ReadHandlerPtr() { public int handler(int offset){ return shared_auxram.read(offset); } };
	public static WriteHandlerPtr shared_auxram_w = new WriteHandlerPtr() {public void handler(int offset, int data){ shared_auxram.write(offset, data); } };
	
	public static ReadHandlerPtr shared_ram_r  = new ReadHandlerPtr() { public int handler(int offset){ return shared_ram.read(offset); } };
	public static WriteHandlerPtr shared_ram_w = new WriteHandlerPtr() {public void handler(int offset, int data){ shared_ram.write(offset, data); } };
