...
public class MapperKonami8Kscc extends Mapper {
   int bank0 = 0;
   int bank1 = 1;
   int bank2 = 2;
   int bank3 = 3;
   ...
   private K051649 scc;
   int[] sccRAM = new int[128];
   private K051649S sccs;

   public MapperKonami8Kscc(char[] var1, K051649 var2) {
      this.scc = var2;
      this.cartMem = var1;
   }

   public MapperKonami8Kscc(char[] var1, K051649S var2) {
      this.sccs = var2;
      this.cartMem = var1;
   }
   ...
   public void write(int var1, int var2) {
      ...
      case 2:
         if(var1 == '退') {
            ...
            this.bank3 = var2;
         } else if(this.bank2 == 63 && var1 >= '頀' && var1 <= '\u9fff') {
            var1 &= 255;
            if(var1 < 128) {
               if(this.scc != null) {
               ...
               if(this.scc != null) {
                  this.scc.K051649_frequency_w(var1 - 128, var2);
               } else {
                  this.sccs.K051649_frequency_w(var1 - 128, var2);
               }
            } else if(var1 < 143) {
               if(this.scc != null) {
                  this.scc.K051649_volume_w(var1 - 138, var2);
               } else {
                  this.sccs.K051649_volume_w(var1 - 138, var2);
               }
            } else if(var1 == 143) {
               if(this.scc != null) {
                  this.scc.K051649_keyonoff_w(var1 - 143, var2);
               } else {
                  this.sccs.K051649_keyonoff_w(var1 - 143, var2);
               }
            } else if(var1 >= 154) {
               ;
            }
