...
public class NetPlay {
    ...
    public NetPlay(ArcoFlexDroid mm) {
        this.mm = mm;
    }
...
/*TODO*///        if (Emulator.netplayInit(null, port, 0) == -1) {
/*TODO*///            Toast.makeText(mm, "Error initializing Netplay!",Toast.LENGTH_SHORT).show();
/*TODO*///            return;
/*TODO*///        }
...
/*TODO*///        if (Emulator.netplayInit(addr, port, 0) == -1) {
/*TODO*///            Toast.makeText(mm, "Error initializing Netplay!",
        ...
        Thread t = new Thread(new Runnable() {
            public void run() {
                while (Emulator.getValue(Emulator.NETPLAY_HAS_JOINED) == 0
                        && !canceled) {
                    try {
/*TODO*///                        if (Emulator.netplayInit(null, 0, 1) == -1)
                            canceled = true;
                        Thread.sleep(1000);
                        //System.out.println("Esperando...");
                    } catch (InterruptedException e) {
